...
class game extends abstract_model {
    ...
    /**
     * @var bool Whether or not questions will be given in sequential ordering oder in a random order
     */
    protected $sequential_question_ordering;
    /**
     * @var int Whether or not questions will be given in sequential ordering oder in a random order
     */
    protected $questions_quantity;
    /**
     * @var int Number of questions which are added to all levels
     */
    ...
    protected $level_tile_alpha;
     /**
     * @var bool The alpha value of the level tile overlay (out of [0,100]).
     */
    protected $general_feedback;
    /**
     * @var bool The alpha value of the level tile overlay (out of [0,100]).
     */
    protected $given_answer_feedback;
     ...
     *
     *TODO Applied Options HEDRE  are availaible in the game!!
     *
     *
     * @param mixed $data
     *
    ...
    public function apply($data) {
        ...
        $this->general_feedback = isset($data['general_feedback']) ? ($data['general_feedback'] == 1) : false;
        $this->given_answer_feedback = isset($data['given_answer_feedback']) ? ($data['given_answer_feedback'] == 1) : false;
        ...
        $this->sequential_question_ordering = isset($data['sequential_question_ordering']) ? ($data['sequential_question_ordering'] == 1) : false;
        $this->questions_quantity = isset($data['questions_quantity']) ? $data['questions_quantity'] : 20;
...
/**
    ...
    // /**
    //  * Gets all inactive levels for this game from the DB.
    //  *
    //  * @return level[]
    //  * @throws \dml_exception
    //  */
    // public function get_inactive_levels() {
    //     global $DB;
     ...
     * @return int
     */
    public function get_question_quantity(): int {
     ...
     * @return bool
     */
    public function is_general_feedback(): bool {
     ...
     * @return bool
     */
    public function is_given_answer_feedback(): bool {
        return $this->given_answer_feedback;
    }
     ...
     * @return bool
     */
    public function is_sequential_question_ordering(): bool {
        return $this->sequential_question_ordering;
    }
