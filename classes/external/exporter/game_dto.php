...
class game_dto extends exporter {
    ...
    protected static function define_other_properties() {
        return [
            ...
            'review_duration' => [
              ...
              'sequential_question_ordering' => [
                'type' => PARAM_BOOL,
                'description' => 'questions in a level are chosen randomly or in dependence of the idnumber of the question',
            ],
             'questions_quantity' => [
                'type' => PARAM_INT,
                'description' => 'the number of questions in sequentiell mode ',
            ],
             'general_feedback' => [
                'type' => PARAM_BOOL,
                'description' => 'whether or not the gamer gets a genereal feedback after answering the question',
            ],
             'given_answer_feedback' => [
                'type' => PARAM_BOOL,
                'description' => 'whether or not the gamer gets a genereal feedback after answering the question',
            ],
    ...
    protected function get_other_values(renderer_base $output) {
        return [
            ...
            'sequential_question_ordering' => $this->game->is_sequential_question_ordering(),
            ...
            'questions_quantity' => $this->game->get_question_quantity(),
            'general_feedback' => $this->game->is_general_feedback(),
            'given_answer_feedback' => $this->game->is_given_answer_feedback(),
