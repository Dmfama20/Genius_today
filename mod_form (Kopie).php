...
class mod_philosophers_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('advcheckbox', 'sequentiell_question_ordering', "Sequentielle Fragenauswahl an Hand Fragen-ID", '&nbsp;');
        $mform->setDefault('sequentiell_question_ordering', 1);
        // ... Number of questions 
        ...
        //$mform->addHelpButton('review_duration', 'review_duration', 'philosophers');
         // ... general feedback?
        $mform->addElement('advcheckbox', 'general_feedback', "Allgemeines ", '&nbsp;');
