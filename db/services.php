...
$functions = [
    ...
    'mod_philosophers_get_question_depending_on_chapter' => [
        'classname' => 'mod_philosophers\external\gamesessions',
        'methodname' => 'get_question',
        'description' => 'Gets or creates the current question from the current gamesession and the current chapter for the logged in user.',
        'type' => 'write',
        'ajax' => true,
    ],
